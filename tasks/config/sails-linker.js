  ...
  grunt.config.set('sails-linker', {
    devJs: {
      ...
      files: {
        ...
        'views/**/*.marko': require('../pipeline').jsFilesToInject
      }
    },
    ...
    prodJs: {
      ...
      files: {
        ...
        'views/**/*.marko': ['.tmp/public/min/production.min.js']
      }
    },
    ...
    devStyles: {
      ...
      files: {
        ...
        'views/**/*.marko': require('../pipeline').cssFilesToInject
      }
    },
